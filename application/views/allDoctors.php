...
<?php
	...
	$this->table->set_heading('Sl No','Name','Mobile','Email id','Action');
    $s=1;
    foreach($alldocs as $doc){
        ...
        // }
        $this->table->add_row($s++,$doc->doc_name,$doc->phno,$doc->mailid,$doc->mailid);
    ...
    <button style="float:right;padding:10px 20px;margin-bottom:10px;" class="btn btn-primary"><a style="color:white;" href="<?php echo base_url().'Main/createdoc'; ?>">Add Doctor</a></button>
    <?php } ?>
